...
verse bien el brillo de la pantalla) ni a los usuarios con dedos grandes, a los que puede dificultarse seleccionar un ítem de la lista debido a su tamaño reducido.
...
seleccionar) se optó inicialmente por crear un menu $ayuda$ en el
...
La solución que se actualmente encuentra aplicada es la de mostrar
un texto en un $Toast$ por un corto intervalo de tiempo, en un lugar poco
invasivo en la pantalla.
...
sentido debido al estado en el que la aplicación se encuentra. Y
es por esto que el botón de ver ordenes se desactiva automaticamente
...
potencial de $Android$ y lo fácil que es diseñar aplicaciones con
